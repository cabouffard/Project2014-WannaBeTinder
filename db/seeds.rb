# Don't delete me, Seedbank gem still needs it
#
...
if !User.where(email: "nault.alex@gmail.com").exists?
  user = User.create(first_name: "Alex", last_name: "Nault", email: "nault.alex@gmail.com", password: "alex123@", profession: User.professions[1], confirmed_at: DateTime.now, admin: true)
  user.save()
end
